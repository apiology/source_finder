...
describe SourceFinder::SourceFileGlobber do
  ...
  describe '#ruby_files_glob' do
    context 'with everything unconfigured' do
      expected_glob = '{Rakefile,{*,.*}.{rb,rake,gemspec},{src,app,lib,' \
                      'test,spec,feature}/**/{*,.*}.{rb,rake,gemspec}}'
  ...
  describe '#source_and_doc_files_glob' do
    context 'with everything unconfigured' do
      expected_glob =
        ...
        'py,clj,cljs,scala,js,yml,sh,json},{src,app,lib,test,spec,feature}' \
        '/**/{*,.*}.{md,rb,rake,gemspec,swift,cpp,c,java,py,clj,cljs,scala,' \
        'js,yml,sh,json}}'
    ...
    before do
      expect(globber).to(receive(:glob))
        .with('{Rakefile,Dockerfile,{*,.*}.' \
              ...
              'yml,sh,json},{src,app,lib,test,spec,feature}/**/{*,.*}.' \
